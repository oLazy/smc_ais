...
!!                           ! ! ! WARNING ! ! !
!!
!! ERIC:: as implemented at the moment the inversion is computed from ping 
!!        checkpoint+1 to the "number of pings" and not from n to n+number of pings
!!        e.i. if number of pings is 34 and checkout is 12 the computation is performed
!!        from 13 to 34 in spite of from 13 to 47
!
iiping = 1
DO iping = 1,NPING
...
PING_LOOP:DO iping = 2,NPING
   ...
   !! 
   !! START THE NAIVE ALGORITHM. RESAMPLE=>RJMCMC=>RESAMPLE
